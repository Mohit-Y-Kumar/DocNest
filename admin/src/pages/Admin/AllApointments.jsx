...
const AllApointments = () => {
  ...
  return (
    <div className='w-full max-w-6xl m-5'>
      ...
      <div className='bg-white border rounded text-sm max-h-[80vh] mix-h-[60vh] overflow-y-scroll'>

        <div className='hidden sm:grid grid-cols-[0.5fr 3fr 1fr 3fr 3fr 1fr 1fr ] grid-flow-col py-3 border-b'>
          <p>#</p>
          <p>Patient</p>
          <p>Age</p>
          <p> Date Time</p>
